...
const SunanNasaiSection: React.FC = () => {
  const volumes: Volume[] = [
    { number: 1, title: "Volume 1", pdfPath: "/pdfs/nasai-volume1(english).pdf" },
    { number: 2, title: "Volume 2", pdfPath: "/pdfs/nasai-volume2(english).pdf" },
    { number: 3, title: "Volume 3", pdfPath: "/pdfs/nasai-volume3(english).pdf" },
    { number: 4, title: "Volume 4", pdfPath: "/pdfs/nasai-volume4(english).pdf" },
    { number: 5, title: "Volume 5", pdfPath: "/pdfs/nasai-volume5(english).pdf" },
    { number: 6, title: "Volume 6", pdfPath: "/pdfs/nasai-volume6(english).pdf" },
  ];
  ...
  return (
    <div className="min-h-screen w-full px-4 py-6 lg:right-72 lg:relative overflow-x-hidden">
      ...
      <div className="text-left md:text-left mb-6">
        <h2 className="text-3xl font-bold text-foreground">Sunan al-Nasa’i</h2>
        <p className="text-muted-foreground arabic text-lg">سنن النسائي</p>
      </div>
            ...
            <CardContent className="p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Sunan al-Nasa’i Collection</p>
                </div>
              </div>
...
export default SunanNasaiSection;
